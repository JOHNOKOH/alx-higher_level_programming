...
'''
    This runs test cases for the square module
'''
...
class test_square(unittest.TestCase):
    ...
    def setUp(self):
        '''
            width and height are initialized with instance
            parameters
        '''
        self.s = Square(5)
    ...
    def test_width(self):
        '''
            Test the square width getter
        '''
        self.assertEqual(5, self.s.width)

    def test_height(self):
        '''
            Test the square height getter
        '''
    ...
    def test_missing_height(self):
        '''
            Expects a type error because height and width are missing
        '''
        with self.assertRaises(TypeError):
            Square()
    ...
    def test_saving_to_file(self):
        '''
            Tests saving a file into json format
        '''
        try:
            os.remove("Square.json")
        except:
    ...
    def test_saving_to_file_None(self):
        '''
            Tests saving a file into json format sending None
        '''
        try:
            os.remove("Square.json")
        except:
    ...
    def test_saving_to_file_type(self):
        '''
            Tests saving a file into json format and testing the type
        '''
        try:
            os.remove("Square.json")
        except:
    ...
    def test_json_string(self):
            '''
                TestS that the json string gets converted into a list
            '''
            list_input = [
                {'id': 2089, 'size': 10},
                {'id': 2712, 'size': 7}]
    ...
    def test_dict_to_instance(self):
        '''
            testS that an instance is created from a dict
        '''
        r1 = Square(5)
...
class TestSquare(unittest.TestCase):
    """
    A class for testing Square class' methods
    """

    @classmethod
    def setUpClass(cls):
        """
        Sets up class method for the doc tests
        """
        cls.setup = inspect.getmembers(Square, inspect.isfunction)

    def test_module_docstring(self):
        """
        This tests if module docstring documentation exist
        """
        self.assertTrue(len(Square.__doc__) >= 1)

    def test_class_docstring(self):
        """
        This tests if class docstring documentation exist
        """
        self.assertTrue(len(Square.__doc__) >= 1)

    def test_wrong_inputted_values(self):
        """
        Tests for negative and zero values
        """
        with self.assertRaises(ValueError):
            S = Square(0, 0)
        with self.assertRaises(ValueError):
    ...
    def test_inputted_types(self):
        """
        have different types for inputted arguments
        """
        with self.assertRaises(TypeError):
    ...
    def test_update_args(self):
        """
        Testing for update method: args
        """
        S = Square(1, 2, 3, 4)
        S.update(6)
    ...
    def test_update_kwargs(self):
        """
        Testing for update method: kwargs
        """
        S = Square(1, 2, 3, 4)
        S.update(6, id=7)
...
class TestSquare(unittest.TestCase):
    """Testing class for Square class."""

    def setUp(self):
        Base._Base__nb_objects = 0

    def test_10_0(self):
        """Testing Square class: check for attributes."""
    ...
    def test_10_2(self):
        """Testing Square class: check for inheritance."""
    ...
    def test_10_4(self):
        """Testing Square for methods inherited from Rectangle."""
    ...
    def test_11_0(self):
        """Testing Square class: check for size attribute."""
    ...
    def test_11_1(self):
        """Testing Square class: check for wrong attributes."""
    ...
    def test_12_0(self):
        """This test update method on Square."""
    ...
    def test_12_1(self):
        """This test for update method on Square with wrong types."""
    ...
    def test_14_0(self):
        """This test for public method to_dictionary."""
