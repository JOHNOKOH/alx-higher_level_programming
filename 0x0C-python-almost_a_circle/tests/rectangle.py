...
'''
    This runs test cases for the Rectangle module
'''


class test_rectangle(unittest.TestCase):
    '''
        This tests rectangle
    '''

    def setUp(self):
        '''
            width and height parameters are initialized by instance
        '''
    ...
    def test_width(self):
        '''
            Tests the Rectangle width getter
        '''
        self.assertEqual(5, self.r.width)

    def test_height(self):
        '''
            Tests the Rectangle height getter
        '''
        self.assertEqual(10, self.r.height)

    def test_x(self):
        '''
            Tests Rectangle x getter and setter
        '''
    ...
    def test_y(self):
        '''
            Tests Rectangle y getter and setter
        '''
    ...
    def test_arectangle_id(self):
        '''
            This tests the id for Rectangle
        '''
    ...
    def test_x_bool(self):
        '''
            Testing for other than integer
        '''
        with self.assertRaises(TypeError):
    ...
    def test_update_dict_list(self):
        '''
            Tests the update method with **kwargs and *args
        '''
    ...
    def test_to_dict(self):
        '''
            Tests the type that is returned from the to_dictionary method
        '''
        r1 = Rectangle(5, 4)
    ...
    def test_to_dict_print(self):
        '''
            Tests the dict that will be printed
        '''
    ...
    def test_missing_height(self):
        '''
            This is expecting a type error because height and width are missing
        '''
        with self.assertRaises(TypeError):
            Rectangle()
    ...
    def test_saving_to_file_no_iter(self):
        '''
            Sends a non iterable to the function
        '''
        with self.assertRaises(TypeError):
    ...
    def test_saving_to_file_None(self):
        '''
            Test saving a file into json format sending None
        '''
        try:
            os.remove("Rectangle.json")
        except:
    ...
    def test_json_string(self):
            '''
                Test that the json string gets converted into a list
            '''
            list_input = [
                {'id': 2089, 'width': 10, 'height': 4},
                {'id': 2712, 'width': 1, 'height': 7}]
    ...
    def test_dict_to_instance(self):
        '''
            This test that an instance is created from a dict
        '''
        r1 = Rectangle(5, 8, 3)
    ...
    def test_load_from_file_same_width(self):
        '''
            This Checks that an object was created from the
...
class TestRectangle(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        Setting up class method for the doc tests
        """
    ...
    def test_class_docstring(self):
        """
        It tests if class docstring documentation exist
        """
        self.assertTrue(len(Rectangle.__doc__) >= 1)

    def test_func_docstrings(self):
        """
        It tests if methods docstring documntation exist
        """
    ...
    def test_wrong_inputted_values(self):
        """
        It test for negative and zero values
        """
        with self.assertRaises(ValueError):
            R = Rectangle(0, 0)
        with self.assertRaises(ValueError):
    ...
    def test_inputted_types(self):
        """
        Different types for inputed arguments
        """
        with self.assertRaises(TypeError):
    ...
    def test_update_args(self):
        """
        This test for update method: args
        """
        R = Rectangle(1, 2, 3, 4, 5)
        R.update(6)
    ...
    def test_update_kwargs(self):
        """
        This test for update method: kwargs
        """
        R = Rectangle(1, 2, 3, 4, 5)
        R.update(6, id=7)
    ...
    def test_dictionary(self):
        """
        This tests for dictionary method
        """
...
class TestRectangle_x(unittest.TestCase):
    """Unittests that test for initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests that test for initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests that test Rectangle order of attribute initialization."""
...
class TestRectangle_area(unittest.TestCase):
    """Unittests that test the area method of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests that test __str__ and display methods of Rectangle class."""
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect (Rectangle): is the Rectangle to print to stdout.
            method (str): is the method to run on rect.
        Returns:
...
class TestRectangle_update_args(unittest.TestCase):
    """Used for testing update args method of the Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Used for testing update kwargs method of the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """This is used for testing to_dictionary method of the Rectangle class."""
