#!/usr/bin/python3
"""This module is a superclass that serves as a base for other classes"""
...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """This Saves the representation of JSON to file"""
    ...
    def from_json_string(json_string):
        """This returns list of JSON string representations"""
        json_string_list = []
    ...
    def load_from_file_csv(cls):
        """CSV format from a file is deserialized"""
